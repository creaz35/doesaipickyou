/**
 * The claw mark, sized for OG image generation. Kept separate from
 * BrandMark because satori (next/og) renders a restricted SVG subset and
 * wants explicit width/height rather than CSS sizing.
 */
export function OgMark({ size = 96 }: { size?: number }) {
  return (
